                   ...
                   <div class="col-md-12">
                    ...
                    <div class="row">
                            ...
                            {{-- <div class="form-group my-3">
                                ...
                                <div class="form-group my-3">
                                    <h6 class="text text-primary" style="font-size: 16px; font-weight: bold;">Enter Amount</h6>
                                    <input type="amount" id="amount" style="font-size: 16px;" placeholder="Enter Amount" class="form-control">
                                </div>
                                <div class="form-group my-3">
                                    <h6 class="text text-primary" style="font-size: 16px; font-weight: bold;">Phone</h6>
                                    <input type="phone" id="phone" style="font-size: 16px;" placeholder="Enter Recipient Phone Number" class="form-control">
                                </div>
                                <div class="form-group my-3">
                                    <label class="text text-primary" style="font-size: 16px; font-weight: bold;">Ported Number</label>
                                    <input type="checkbox" id="ported">
                                </div>
                                <div class="form-group my-3">
           ...
           if( $('#ported').is(':checked') ){
            ...
            $.ajax({
                ...
                success: function (response){
                    ...
                    if(response == "Airtime Purchase is Sucessfull!"){
                        Swal.fire({
